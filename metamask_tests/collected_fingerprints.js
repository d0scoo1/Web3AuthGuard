...
"Decert":['Welcome',' ',  'to',' ',  'Decert!','\n\n','This',   ' ',  'request',' ',  'will',   ' ','not',' ',  'trigger',' ',  'a',  ' ',
'blockchain', ' ',  'transaction',' ',  'or', ' ','cost',   ' ',  'any',' ',  'gas',' ','fees.',  '\n\n',   'Your',' ',  'authentication', ' ','status', ' ',  'will',' ',  'reset',  ' ','after',  ' ',  '24',' ',  'hours.', '\n\n','Wallet', ' ',  'address:','\n', '_address_',  '\n\n','Nonce:', '\n', '_nonce_'],

"Paragraph":['Welcome', ' ', 'to', ' ','Paragraph!',  ' \n\n', 'Click',  ' ','to',  ' ', 'sign',   ' ','in.', '\n\n',  'This',   ' ','request', ' ', 'will',   ' ','not', ' ', 'trigger',' ','a',   ' ', 'blockchain', ' ',
'transaction', ' ', 'or', ' ','cost',' ', 'any',' ','gas', ' ', 'fees.',  '\n\n','Here',' ', 'is', ' ','your',' ', 'nonce:', ' ','_nonce_'  ]
}



// "Campfire":[], //Sign-in request
// Update Profile "NFTmall":[],

// "Galxe":[], EIP4361
//"MOBOX":[], //wallet_login_27896169
//"Bomb Crypto 2":["_address_","-","_nonce_"], // 0x36e7c6feb20a90b07f63863d09cc12c4c9f39064-1673772431957